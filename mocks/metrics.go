...
func (fake *Metrics) IncReposScanned() {
	...
	fake.recordInvocation("IncReposScanned", []interface{}{})
	fake.incReposScannedMutex.Unlock()
	if stub != nil {
		fake.IncReposScannedStub()
	}
}
...
func (fake *Metrics) IncReposScannedCalls(stub func()) {
	fake.incReposScannedMutex.Lock()
