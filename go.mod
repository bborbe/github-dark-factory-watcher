module github.com/bborbe/github-dark-factory-watcher

go 1.27.0

replace (
	k8s.io/api v0.37.0 => k8s.io/api v0.36.3
	k8s.io/apiextensions-apiserver v0.37.0 => k8s.io/apiextensions-apiserver v0.36.3
	k8s.io/apimachinery v0.37.0 => k8s.io/apimachinery v0.36.3
...
require (
	...
	github.com/bborbe/argument/v2 v2.13.0 // indirect
	...
	github.com/bborbe/vault-cli v0.116.3 // indirect
